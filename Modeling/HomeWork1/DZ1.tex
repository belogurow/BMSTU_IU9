...
\section{Постановка задачи}
    ...
    \begin{center}
        \begin{minipage}{0.7\linewidth}
            ...
            \captionof{figure}{STL модель Patella}
        \end{minipage}
    \end{center}
    ...
    \begin{center}
        \begin{minipage}{0.7\linewidth}
            ...
            \captionof{figure}{Триангулированная STL модель Patella (вид изнутри)}
        \end{minipage}
    \end{center}
...
\section{Результаты}
    ...
    \begin{center}
        \begin{minipage}{0.7\linewidth}
            ...
            \captionof{figure}{Верхняя часть ($Z > 30$) - вид сверху (1)}
        \end{minipage}
    \end{center}
    \begin{center}
        \begin{minipage}{0.7\linewidth}
            \includegraphics[width=\linewidth]{img/up_view_above_1}
            \captionof{figure}{Верхняя часть ($Z > 30$) - вид сверху (2)}
        \end{minipage}
    \end{center}
    \begin{center}
        \begin{minipage}{0.7\linewidth}
            \includegraphics[width=\linewidth]{img/down_view_above_0}
            \captionof{figure}{Нижня часть ($Z \leq 30$) - вид сверху}
        \end{minipage}
    \end{center}
    \begin{center}
        \begin{minipage}{0.7\linewidth}
            \includegraphics[width=\linewidth]{img/down_view_bottom_0}
            \captionof{figure}{Нижня часть ($Z \leq 30$) - вид снизу}
        \end{minipage}
    \end{center}
    ...
    \begin{center}
        \begin{minipage}{0.57\linewidth}
            ...
            \captionof{figure}{Обе части - вид сверху}
        \end{minipage}
    \end{center}
    ...
    \begin{center}
        \begin{minipage}{0.57\linewidth}
            ...
            \captionof{figure}{Обе части - вид снизу}
        \end{minipage}
    \end{center}
    ...
    \begin{center}
        \begin{minipage}{0.7\linewidth}
            ...
            \captionof{figure}{Обе части - вид сбоку}
        \end{minipage}
    \end{center}
